...
$this->title='Parsing / Upload  product excel';
...
<div class="sintret-update">
    ...
    <div class="row">
        <div class="col-md-10">
            Format Sample : <a href="<?php echo Yii::$app->urlManager->createUrl('product/sample');?>">product.xls</a>
        </div>
