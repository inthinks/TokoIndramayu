...
$this->title='Parsing / Upload  user_type excel';
$this->params['breadcrumbs'][] = ['label' => 'user_type', 'url' => ['index']];
...
<div class="sintret-update">
    ...
    <div class="page-header">
        <h1>Parsing Excel user_type</h1>
    </div>


    <div class="user_type-form">
    ...
    <div class="row">
        <div class="col-md-10">
            Format Sample : <a href="<?php echo Yii::$app->urlManager->createUrl('user-type/sample');?>">user-type.xls</a>
        </div>
