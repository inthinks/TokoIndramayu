...
$this->title='Parsing / Upload  category excel';
...
<div class="sintret-update">
    ...
    <div class="row">
        <div class="col-md-10">
            Format Sample : <a href="<?php echo Yii::$app->urlManager->createUrl('category/sample');?>">category.xls</a>
        </div>
