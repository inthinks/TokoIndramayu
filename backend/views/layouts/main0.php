...
<body>
    ...
    <div class="wrap">
        <?php
            ...
            NavBar::begin([
                'brandLabel' => 'Khas Indramayu <i class="fa fa-plug"></i> Admin',
            ...
            NavBar::begin([
                'brandLabel' => 'Admin Khas Indramayu',
                'brandUrl' => Yii::$app->homeUrl,
                'options' => [
                    'class' => 'navbar-inverse navbar-fixed-top',
                ],
            ...
            if (!Yii::$app->user->isGuest && Yii::$app->user->identity->role_id>=$is_admin) {
                ...
                $menuItems[] = ['label' => 'User Type', 'url' => ['/user-type/index']];
    ...
    <footer class="footer">
        <div class="container">
        <p class="pull-left">&copy; Inthinks <?= date('Y') ?></p>
