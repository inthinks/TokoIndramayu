...
$this->title='Parsing / Upload  order_detail excel';
$this->params['breadcrumbs'][] = ['label' => 'order_detail', 'url' => ['index']];
...
<div class="sintret-update">
    ...
    <div class="page-header">
        <h1>Parsing Excel order_detail</h1>
    </div>


    <div class="order_detail-form">
        ...
        <div class="order_detail-form">
            ...
            <div class="notifications" style="display: none">Please wait, while loading.... <img src="/img/loadingAnimation.gif"></div>
    ...
    <div class="row">
        <div class="col-md-10">
            Format Sample : <a href="<?php echo Yii::$app->urlManager->createUrl('order-detail/sample');?>">order-detail.xls</a>
        </div>
