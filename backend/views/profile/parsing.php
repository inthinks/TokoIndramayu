...
$this->title='Parsing / Upload  profile excel';
...
<div class="sintret-update">
    ...
    <div class="row">
        <div class="col-md-10">
            Format Sample : <a href="<?php echo Yii::$app->urlManager->createUrl('profile/sample');?>">profile.xls</a>
        </div>
