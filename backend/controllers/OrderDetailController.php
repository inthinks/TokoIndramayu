...
class OrderDetailController extends Controller
{
    ...
    public function actionSample() {
        ...
        $model = new OrderDetail;
        $date = date('YmdHis');
        $name = $date.'OrderDetail';
        //$attributes = $model->attributeLabels();
        $models = OrderDetail::find()->all();
    ...
    public function actionParsing() {
        ...
        if (Yii::$app->request->isPost) {
            ...
            $model->title = 'parsing OrderDetail';
            ...
            if ($model->save()) {
                $log = 'log_OrderDetail'. Yii::$app->user->id;
                ...
                $notification->title = 'parsing OrderDetail';
                $notification->message = Yii::$app->user->identity->username . ' parsing OrderDetail ';
                $notification->params = \yii\helpers\Json::encode(['model' => 'OrderDetail', 'id' => $model->id]);
                $notification->save();
            }
        }
        $route = 'orderdetail/parsing-log';
        ...
        $not = Util::excelNot();
            ...
            foreach ($values as $value) {
                if ($type == LogUpload::TYPE_INSERT)
                    ...
                    $model = OrderDetail::findOne($value['id']);
