...
class ProductController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        if(PermissionHelpers::harusPemilik('Product') || PermissionHelpers::requireRole('admin')) {
    ...
    public function actionParsing() {
        ...
        if (Yii::$app->request->isPost) {
            ...
            if ($model->save()) {
                $log = 'log_Product'. Yii::$app->user->id;
                ...
                $notification->title = 'parsing Product';
                $notification->message = Yii::$app->user->identity->username . ' parsing Product ';
                $notification->params = \yii\helpers\Json::encode(['model' => 'Product', 'id' => $model->id]);
                $notification->save();
            }
        }
        $route = 'product/parsing-log';
        ...
        $not = Util::excelNot();
            ...
            foreach ($values as $value) {
                if ($type == LogUpload::TYPE_INSERT)
                    ...
                    $model = Product::findOne($value['id']);
